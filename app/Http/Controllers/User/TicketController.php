...
class TicketController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        $request->validate([
            ...
            'category.required' => 'Pilih kategori masalah.',
            'description.required' => 'Jelaskan kendala Anda secara detail.',
        ...
        return redirect()->route('user.tickets.show', $ticket)
            ->with('success', "Tiket bantuan #{$ticket->ticket_code} berhasil dibuat. Tim admin akan segera merespon.");
    }
    ...
    public function reply(Request $request, Ticket $ticket): RedirectResponse
    {
        ...
        if ($ticket->status === 'closed') {
            return back()->with('error', 'Tiket ini telah ditutup dan tidak dapat dibalas lagi.');
        }
        ...
        return redirect()->route('user.tickets.show', $ticket)
            ->with('success', 'Balasan Anda berhasil dikirimkan ke Admin.');
    }
}
