    ...
    <div class="min-h-screen flex">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="flex-1 overflow-y-auto px-4 py-6 space-y-1.5">
                ...
                <!-- Kelola Menu (Katalog Makanan & Minuman) -->
                @if($hasStore)
                    <a href="{{ route('staff.menus.index') }}"
                       class="flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-semibold transition-all {{ request()->routeIs('staff.menus.*') ? 'bg-blue-600 text-white shadow-md shadow-blue-600/30' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                        <div class="flex items-center space-x-3">
