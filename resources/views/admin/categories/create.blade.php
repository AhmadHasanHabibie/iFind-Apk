...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 sm:p-8">
        <h2 class="text-xl font-bold text-slate-900 mb-6">Form Tambah Kategori</h2>
        ...
        <form method="POST" action="{{ route('admin.categories.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <p class="text-[11px] text-slate-400 mt-1">Slug URL akan dibuat otomatis berdasarkan nama kategori.</p>
            </div>
            ...
            <div>
                ...
                <input type="text"
                       ...
                       class="w-full text-sm rounded-xl border-slate-300 focus:border-teal-500 focus:ring-teal-500">
                <p class="text-[11px] text-slate-400 mt-1">Nama icon FontAwesome atau class identifier (tidak perlu upload gambar).</p>
            </div>
            ...
            <div>
                ...
                <textarea id="description"
                          ...
                          class="w-full text-sm rounded-xl border-slate-300 focus:border-teal-500 focus:ring-teal-500">{{ old('description') }}</textarea>
            </div>
