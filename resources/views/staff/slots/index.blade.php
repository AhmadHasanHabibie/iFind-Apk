                            ...
                            <td class="py-4 px-6 text-right">
                                <div class="inline-flex items-center space-x-1.5">
                                    @if($slot->status !== 'closed')
                                        <form method="POST" action="{{ route('staff.slots.close', $slot) }}" onsubmit="return confirm('Tutup slot ini sekarang?')">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit"
                                                    title="Tutup Manual"
                                    ...
                                    <form method="POST" action="{{ route('staff.slots.destroy', $slot) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus slot waktu ini?')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                                title="Hapus Slot"
